...
use bevy::prelude::{
    Changed, Commands, Component, Entity, MessageReader, Query, Res, Sprite, SpriteImageMode,
};
use bevy::sprite::TextureSlice;
use bevy_sprite_render::ExtractedSlice;
...
///
/// TODO we may want to adapt this for animations
